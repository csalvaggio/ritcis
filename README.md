...
To date, 99 forms have been prepared and used to create the current instantiation of the database.  This instantiation is split into 36,381 training images and 7,277 test images.
